...
class EnglishProcessor(object):
    ...
    def replace(self, sentence):
        ...
        words = [replacement[word]
                 if word in replacement else word for word in words]
    ...
    def remove_chinese(self, sentence):
        ...
        sentence_repl = re.sub(
            r"肏你祖宗十八代", "your ancestors to the 18th generation", sentence_repl)
        return sentence_repl
